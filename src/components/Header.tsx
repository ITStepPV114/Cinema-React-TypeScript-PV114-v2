...
import { logout } from "../store/user/userSlise";
...
const settings = [ { itemName: 'Login', path: 'login' }, { itemName: 'Registration', path: 'registration' }];
        ...
        <AppBar position="static">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                        ...
                        >
                            <Link style={{color:'white', textDecoration:'none'}} to={pages[0].path}> LOGO</Link>
                        </Typography>
                        ...
                        >
                            {settings.map((setting) => (
                                ...
                                <MenuItem key="logout" onClick={handleCloseUserMenu}>
                                    <Typography textAlign="center"><Button onClick={logoutHandler}>Logout</Button></Typography>
                                </MenuItem>
